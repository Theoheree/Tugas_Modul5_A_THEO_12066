...
model_path = r'D:\PEMBELAJARAN MESIN\Tugas_Modul5_A_THEO_12066\best_model_tf.h5'
...
if os.path.exists(model_path):
    try:
        ...
        # UI Streamlit
        st.title("Fashion MNIST Image Classifier 2066")  # Ganti xxxx dengan 4 digit NPM
